...
| **TC_1.03** | UI/UX | ตรวจสอบการแสดงผลรูปภาพ Reference บนมือถือ | รูปภาพไม่เบี้ยวและปรับขนาดตามหน้าจอได้อย่างถูกต้อง | Pass ✅ |
...
| **TC_2.02** | Authorization | ทดสอบการจัดการสิทธิ์การเข้าถึงหน้า Admin Dashboard ของลูกค้าทั่วไป | ระบบป้องกันไม่ให้ลูกค้าทั่วไปเข้าถึงได้ (แสดงข้อความแจ้งเตือน) | Pass ✅ |
...
| **TC_5.02** | Payment | ตรวจสอบการอัปโหลดไฟล์สลิป (รูปแบบ .jpg) | ระบบอัปโหลดไฟล์สำเร็จและแสดงตัวอย่างภาพสลิป | Pass ✅ |
